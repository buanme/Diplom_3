...
class TestLK:
    ...
    def test_navigate_to_lk(self, login_page, personal_account_page):
        ...
        assert personal_account_page.driver.current_url.endswith("/account/profile")
    ...
    def test_navigate_to_history_orders(self, login_page, personal_account_page):
        ...
        assert personal_account_page.driver.current_url.endswith("/account/order-history")
    ...
    def test_logout_from_lk(self, login_page, personal_account_page):
        ...
        assert personal_account_page.driver.current_url.endswith("/login")
